 ...
 ******************************************************************************
 * @file    app_conf.h
 * @author  MCD Application Team @brief   Application configuration file for STM32WPAN Middleware.
 ******************************************************************************
 * @attention
 *
 ...
 */
#define CFG_GAP_DEVICE_NAME             "ETH_BLE_DEMO"
 ...
 */
#define CFG_BLE_MAX_ATT_MTU             (214)
...
typedef enum
{
  ...
  CFG_TASK_USR_BTN1_PRESS_ID,
  CFG_TASK_USR_BTN2_PRESS_ID,
  CFG_TASK_USR_DATA_TIMER_ID,
